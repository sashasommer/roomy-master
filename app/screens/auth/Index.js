...
function LoginScreen(props) {
    ...
    return (
        <View style={styles.container}>
            ...
            {/* Wecome Text */}
            <View style={{ backgroundColor: Colors.background, width: "100%", flex: 0.78, flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }} >
                <Image source={logo} style={{width: "50%", height: "30%"}}/>

                <Text style={{ marginTop: 20, color: Colors.white, fontSize: RFPercentage(3.6) }}>
                    Welcome
                </Text>
            </View>
